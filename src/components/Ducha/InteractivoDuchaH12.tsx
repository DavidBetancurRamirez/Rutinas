...
const DraggableCharacter = ({ onEnterShower }: { onEnterShower: () => void }) => {
    ...
    return (
        ...
        >
            <Image
                source={require('@/assets/images/Chico (Sin Ropa).webp')}
...
const InteractivoDuchaH12: React.FC = () => {
    ...
    const [clothes, setClothes] = useState<ClothingItem[]>([
        ...
        {
            key: 'shirt',
            source: require('@/assets/images/Camisa.webp'),
    ...
    const bodyParts = [
        ...
        {
            id: 'pene',
            image: require('@/assets/images/Pene.webp'),
            position: {
                top: 300 * scaleY,
                left: 100 * scaleX,
                width: 70 * scaleX,
...
export default InteractivoDuchaH12;
