...
// Image imports
const IMAGES = {
    pee: require('@/assets/images/Pis Hombre.webp'),
    ...
    pantsDown: require('@/assets/images/Bajar Pantalones (Hombre).webp'),
    underwearDown: require('@/assets/images/Bajar Ropa Interior (Hombre).webp'),
    manSitting: require('@/assets/images/Hombre Sentado.webp'),
    menPeeBefore: require('@/assets/images/Hombre Antes Pis.webp'),
    menPeeAfter: require('@/assets/images/Hombre Despues Pis.webp'),
    manPoop: require('@/assets/images/Hombre Popo.webp'),
    toiletPaper: require('@/assets/images/Papel.webp'),
    wipePee: require('@/assets/images/Limpiar Pene.webp'),
    wipePoop: require('@/assets/images/Limpiar Popo (Hombre).webp'),
    ...
    pullUpPants: require('@/assets/images/Subir Pantalones (Hombre).webp'),
    pullUpUnderwear: require('@/assets/images/Subir Ropa Interior (Hombre).webp'),
...
export default InteractivoBañoH0;